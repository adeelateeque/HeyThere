...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter]
     addObserver:self
     selector:@selector(pullNational:)
     name:@"getnational" object:nil];
...
- (void)locationManager:(CLLocationManager *)manager
    ...
    [NSString stringWithFormat:@"http://21.com.au/d21-backend/national-weather.php?latinput=%f&longinput=%f", location.coordinate.latitude, location.coordinate.longitude];
    ...
    [[NSNotificationCenter defaultCenter]
     postNotificationName:@"getnational"
     object:self
     userInfo:dict];
    
}

- (void)pullNational:(NSNotification *)notification {
    
    // do temp data requests
    
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"getnational" object:nil];
